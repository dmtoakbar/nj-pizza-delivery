...
class TermsConditionPolicyPage extends GetView<TermsConditionPolicyController> {
  const TermsConditionPolicyPage({super.key});
    ...
    return Scaffold(
     backgroundColor: Colors.white,
      body: Column(
        children: [
          SizedBox(height: 8),
          CustomHeader(title: 'Terms And Condition', showCart: true,),
          Expanded(
            child: Obx(() {
