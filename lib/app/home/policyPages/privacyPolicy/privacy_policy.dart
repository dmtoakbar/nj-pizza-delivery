...
import 'package:nj_pizza_delivery/app/home/policyPages/privacyPolicy/controller/privacy_policy_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 8),
          CustomHeader(title: 'Privacy Policy', showCart: true,),
          Expanded(
            child: Obx(() {
